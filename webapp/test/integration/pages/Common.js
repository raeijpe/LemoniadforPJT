sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/mentors/lemonaid/projectteam/app", ".html");
		...
		return Opa5.extend("com.sap.mentors.lemonaid.projectteam.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/mentors/lemonaid/projectteam/localService/mockserver"], function (mockserver) {
